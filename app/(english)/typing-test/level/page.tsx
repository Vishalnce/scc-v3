  ...
  return (
    <>
      ...
      <div className="dark:bg-black py-18">
        <div className="w-[90%] py-2 mx-auto shadow-[0_0_9px_rgba(0,0,0,0.2)] bg-white dark:bg-[#313131] rounded-2xl">
          {/* Heading */}
          <div className="flex flex-col items-center my-4">
            ...
            <p className="text-my-text-color dark:text-gray-300">
      ...
      <div
        className="w-[90%] mx-auto rounded-2xl p-5 md:p-10
                bg-white dark:bg-[#1f1f1f]
                shadow-[0_0_9px_rgba(0,0,0,0.2)]"
      >
        {/* Badge */}
        <div className="mb-4">
          <span
            className="bg-gray-200 dark:bg-[#3a3a3a]
        ...
        <div className="flex flex-col gap-4 md:gap-6">
          {features.map((item, index) => (
            <div key={index} className="flex items-start gap-3">
              {/* Icon */}
              <div
                className="bg-[#E6F4F1] dark:bg-[#16423d]
                        p-2 rounded-full shrink-0"
              >
                <IoCheckmark className="text-[#0F766E] dark:text-[#5eead4] text-lg" />
              </div>
