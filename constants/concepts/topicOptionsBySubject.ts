...
export const topicOptionsBySubject: Record<string, TopicOption[]> = {
  "english-comprehension": [
    ...
    { label: "Error Spotting and Sentence Improvement", value: "error-spotting-sentence-improvement" },
  ...
  "reasoning-general": [
    ...
    {label: "Non-Verbal Reasoning (Mirror Image, Water Image, Paper Folding, etc.)", value: "non-verbal-reasoning"},
...
{  label: "Basics of Computers", value: "basics-computers" },
  ...
  {  label: "Computer Abbreviations and Terminology", value: "computer-abbreviations" },
  ],
