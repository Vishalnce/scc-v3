...
export default function MarksCard({questions,answers,timeTaken,timeLimit,onRestart}:Props) {

    const calculateScore = () => {
    let correctMarks = 0;
    let incorrectMarks = 0;
    let totalMarks = questions.reduce((sum:any, q:any) => sum + q.marksPositive, 0);
