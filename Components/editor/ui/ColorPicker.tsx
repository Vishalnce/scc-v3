        ...
        {basicColors.map((basicColor) => (
          <button
            ...
            style={{
              backgroundColor:
                basicColor === "default"
                  ? "var(--color-my-text-color)"
                  : basicColor,
            }}
            onClick={() => {
              setInputColor(basicColor === "default" ? "" : basicColor);

              if (basicColor === "default") {
                // Remove inline color → will use theme variable
                setSelfColor({
                  hex: "", // or keep last color, doesn't matter
                  hsv: selfColor.hsv,
                  rgb: selfColor.rgb,
                });
              } else {
