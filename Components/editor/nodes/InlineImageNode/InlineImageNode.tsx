...
export class InlineImageNode extends DecoratorNode<JSX.Element> {
  ...
  exportDOM(): DOMExportOutput {
    ...
    element.setAttribute('height', this.__height.toString());
      // Inject position-specific styling
  const style = (() => {
    switch (this.__position) {
      case 'left':
        return 'float: left; margin-right: 1em; max-width: 50%;';
      case 'right':
        return 'float: right; margin-left: 1em; max-width: 50%;';
      case 'full':
        return 'display: block; width: 100%; margin: 1em auto;';
      default:
        return '';
    }
  })();
