...
async  function TestSeriesCard() {

  const session = await getServerSession(NEXT_AUTH);
  return (
    <>
      <div className=" dark:bg-[#1f1f1f] py-8 ">
        <div className=" mx-auto  w-[90%] max-w-[1400px]  flex rounded-xl flex-col  border-1 border-[#DADADA] px-8 dark:text-white">
          {/* new launced */}
          <div className=" py-4">
            <button className=" bg-[#F4F4FC] dark:bg-[#292728] rounded-2xl py-2 px-4">
              {" "}
              New Launched
            </button>
          </div>
          ...
          <div className="flex flex-col py-4  ">
            ...
            <p className="text-[#6F6F6F] dark:text-white">
              Sharpen Your Skills and Track Your Progress with mock test and
              test series.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 max-md:grid-cols-1 gap-4">
            <div className=" flex flex-row  gap-4">
              ...
              <div className="my-auto">
                ...
                <p className="text-[#6F6F6F] dark:text-white"> Full length mocks</p>
              </div>
            </div>
            ...
            <div className=" flex flex-row  gap-4">
              ...
              <div className="my-auto">
                ...
                <p className="text-[#6F6F6F] dark:text-white"> Performance insights</p>
              </div>
            </div>
            ...
            <div className=" flex flex-row  gap-4">
              ...
              <div className="my-auto">
                ...
                <p className="text-[#6F6F6F] dark:text-white"> Know Your Standing</p>
              </div>
            </div>
            ...
            <div className=" flex flex-row  gap-4">
              ...
              <div className="my-auto">
                ...
                <p className="text-[#6F6F6F] dark:text-white"> Pre + Mains</p>
              </div>
            </div>
          </div>
          ...
          <div className=" w-full flex flex-row  justify-between text-white max-md:pt-4 py-8">
            <button className=" w-[48%] bg-[#047077] py-2 rounded-xl ">
              Mock Test
            </button>
