          ...
          <div className="flex flex-row justify-between items-center max-md:flex-col max-md:gap-8">
            ...
            <div className=" w-[46%] max-md:w-[100%] shadow-2xl rounded-2xl overflow-hidden ">
              ...
              <div className="  bg-[#007076] rounded-t-xl flex flex-row items-center justify-center gap-4  py-1 w-full">
                ...
                <div>
                  <p className="text-white text-2xl"> Prelims Test Series</p>
                </div>
              </div>
              ...
              <div className=" py-3 space-y-3   px-3  dark:bg-[#313131] ">
                {pre.map((item: any, index) => (
                  ...
                  >
                    ...
                    <p className="text-[#6C6C6C] dark:text-[#C2C2C2] text-lg  my-auto w-[60%]">
                      {item.title}
                    </p>
                  </div>
                ))}
            ...
            <div className=" w-[46%] max-md:w-[100%] shadow-2xl  rounded-2xl overflow-hidden">
              ...
              <div className="  bg-[#007076] rounded-t-xl flex flex-row items-center justify-center gap-4  py-1 w-full ">
                ...
                <div>
                  <p className="text-white text-2xl"> Mains Test Series</p>
                </div>
              </div>
