        ...
        <div className="flex flex-row relative items-center justify-center max-md:justify-start md:pt-4 md:px-6 max-md:py-2 px-2 ">
          ...
          <div className="flex flex-col justify-between items-start md:gap-6 w-[70%] pr-4  max-md:py-4 md:pt-10  max-md:w-[70%] ">
            <p className="text-4xl max-md:text-xl text-white font-montserrat font-semibold">
              Upgrade to Pro  <span className="max-md:hidden">for In-Depth Performance Analysis </span>
            </p>

            <p className="text-white text-xl max-md:text-sm max-md:leading-4 max-md:pt-2">
              Unlock detailed insights after every test, <span className="max-md:hidden">understand where you
              went wrong, track your progress over time, and improve your </span> 
              accuracy and speed
            </p>

            
              <button className=" px-8 md:mt-4 max-md:mt-4 bg-[#FFFFFFCC] max-md:text-xs  text-xl md:px-16 py-2 rounded-2xl font-semibold whitespace-nowrap">Upgrade Now</button>
          </div>

          {/* image */}
          <div className=" max-md:absolute right-4 max-md:w-[30%] w-[25%]  ">
            <Image
