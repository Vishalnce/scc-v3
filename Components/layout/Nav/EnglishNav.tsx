...
function Nav() {
  ...
  return (
    <>
      <nav className="bg-white  w-full sticky z-50   top-0 px-4 py-2  shadow-md">
        <div className="  flex flex-row justify-between items-center mx-auto  py-1  md:w-[95%]  ">
          ...
          <div className="flex flex-row justify-around items-center space-x-2 mx-2">
            ...
            {status === "authenticated" ? (
              <div>
                <button
                  className="px-6 py-0.5 pb-1 border-2 border-[#007076] rounded-lg bg-my-green text-white max-lg:text-md max-sm:px-2  "
                  onClick={() => {
                    signOut();
                  }}
                >
