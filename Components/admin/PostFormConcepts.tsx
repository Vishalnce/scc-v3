...
const subjectOptions = [
  { value: "gs1", label: "GS 1" },
  { value: "gs2", label: "GS 2" },
...
const handleTopicChange = (option: OptionType | null) => {
 ...
 useEffect(() => {
  if (post?.category) {
    const matched = categoryOptions.find((opt) => opt.value === post.category);
    if (matched) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-6">
      ...
      <Select<OptionType>
        ...
        onChange={handleSubjectChange} // ✅ this will call setSelectedOption + setValue("category", ...)
      ...
      <Select<OptionType>
        ...
        value={selectedTopic}
        onChange={handleTopicChange} // ✅ this will call setSelectedOption + setValue("category", ...)
